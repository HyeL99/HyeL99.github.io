...
<h6>h6 태그의 크기</h6>
```
<div style="background:#eee; padding: 40px; box-sizing: border-box; border-radius: 10px; color: black;">
    <p>실행결과</p>
	<h1 style="color:#000;">h1 태그의 크기</h1>
	<h2 style="color:#000;">h2 태그의 크기</h2>
	<h3 style="color:#000;">h3 태그의 크기</h3>
...
> `<pre>` 태그(preformmatted text) 내에 작성된 텍스트의 모든 띄어쓰기와 줄 나누기는 웹 브라우저에 그대로 표현된다.
> 
> ```html
> <pre>
> 	태그 내 줄바꿈 테스트
...
>        ```
>
> <div style="background:#eee; padding: 40px; box-sizing: border-box; border-radius: 10px; color: black; width: 94%; margin-left: 6%;">
>   <p>실행결과</p>
>   <p><b>"이 부분"</b>은 단순히 글씨가 굵은 부분이에요!</p>
>   <p><strong>"이 부분"</strong>은 중요한 부분이라서 굵게 표현됐어요!</p>
> </div>
...
- ### 블록 인용구
    ...
    길이가 긴 인용문은 `<blockquote>`태그(block quatation)를 사용하여 표현할 수 있다.<br />
...
- ### 주소 표현
    ...
    <div style="background:#eee; padding: 40px; box-sizing: border-box; border-radius: 10px; color: black;">
        <p>실행결과</p>
        <address>깃허브시 HyeL99구 블로그로</address>
    <div>
